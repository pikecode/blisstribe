...
一、协议说明
本协议由杭州隐途文化旅游发展有限公司（以下简称“我们”）与使用 BlissTribe 小程序的用户订立。请你在使用服务前仔细阅读并理解本协议及《隐私政策》。你勾选同意并完成注册，即表示已阅读、理解并同意接受本协议全部内容。

二、服务内容
BlissTribe 为用户提供需求评估、产品与服务推荐、咨询线索提交、活动报名、邀请关系及服务伙伴入驻等功能。平台提供的信息主要用于需求匹配和服务信息展示，不构成医疗诊断、治疗建议或其他专业结论。涉及具体服务时，请你向具备相应资质的服务方进一步核实。

三、账号与资料
1. 你应通过微信登录并按页面提示完成手机号授权和资料填写。你应保证提交的资料真实、准确、完整，并在资料变化时及时更新。
2. 账号仅限本人使用。你应妥善保管登录状态，不得出租、出借、转让或以其他方式允许他人使用账号。
3. 如发现账号异常、未经授权使用或安全风险，请及时联系我们。

四、用户行为规范
你不得利用本服务从事违法活动，不得发布虚假、侵权、骚扰、欺诈、恶意营销或危害他人权益的内容，不得干扰系统运行、尝试绕过安全措施或未经授权访问其他用户数据。违反约定时，我们有权根据情节采取提醒、限制功能、暂停或注销账号等措施。

五、用户内容与知识产权
你对自行提交的文字、图片和其他内容承担相应责任，并保证拥有必要的授权。平台及其相关页面、文字、图像、软件和商标的知识产权归我们或相关权利人所有，未经许可不得复制、传播或用于商业用途。

六、服务变更与免责
我们会根据业务、法律法规和安全要求调整服务，并通过小程序或其他合理方式提示重要变化。因网络、设备、不可抗力或第三方平台原因导致的服务中断，我们将在合理范围内采取补救措施。平台不对用户与独立服务方之间的服务质量、交易或其他争议作超出法律规定的保证。

七、账号注销
你可以在小程序“我的”页面申请注销账号。注销完成后，我们将删除或清除账号资料、头像、手机号、评估信息等可删除的个人信息；法律法规要求留存的记录除外，并在留存期限届满后删除或匿名化处理。注销后账号及相关服务无法恢复。

八、协议更新与争议解决
我们可能根据服务变化更新本协议。更新后的协议将在小程序中展示，重大变更会以适当方式提示。因本协议产生的争议，双方应先协商解决；协商不成的，按照中华人民共和国法律处理。

九、联系我们
运营主体：杭州隐途文化旅游发展有限公司
联系地址：浙江省杭州市余杭区闲林街道闲富中路57号七彩汇商业中心2幢313室
联系电话：18957163459
`,
  },
  privacy: {
...
杭州隐途文化旅游发展有限公司（以下简称“我们”）重视你的个人信息保护。本政策说明我们在 BlissTribe 小程序中如何收集、使用、保存、删除和保护你的个人信息。请在使用服务前仔细阅读。

一、我们收集的信息
1. 注册与登录：微信登录标识（服务端仅保存经过处理的标识）、微信昵称、微信头像、性别，以及你授权提供的手机号。
2. 用户资料：昵称、头像、生日、年龄、真实姓名、微信号、邮箱、职业、偏好颜色、兴趣标签等你主动填写的信息。
3. 服务使用：健康需求评估答案、产品推荐结果、咨询线索、活动报名、邀请关系和服务伙伴申请资料。
4. 安全与运行：为保障服务稳定和安全，服务器可能记录必要的请求时间、IP 地址、设备及网络请求信息。

二、信息使用目的
我们仅为实现账号注册登录、身份核验、需求评估、服务推荐、活动报名、咨询跟进、邀请关系管理、服务伙伴审核、客户服务、安全风控和法律合规目的处理上述信息，不将个人信息用于与服务无关的广告营销。

三、微信平台能力
小程序使用微信提供的登录和手机号授权能力。相关授权由微信平台完成，我们只接收完成 BlissTribe 服务所必需的结果。除微信基础平台能力外，我们不接入广告、第三方统计、第三方推送或其他第三方 SDK 服务。

四、信息保存与保护
我们在必要期限内保存信息，并采取访问权限控制、传输加密、敏感字段加密或哈希处理、日志审计等措施保护信息。手机号等敏感信息不会以明文形式用于普通业务展示。除法律法规另有要求外，我们不会向无关第三方出售或提供你的个人信息。

五、信息删除与用户权利
你可以通过小程序注销账号，或通过本政策联系方式提出查询、更正、删除个人信息、撤回授权和获取处理说明的请求。注销后，我们将删除或清除账号资料、头像、手机号、评估信息等可删除的个人信息；法律法规要求留存的记录除外，并在留存期限届满后删除或匿名化处理。

六、未成年人保护
本服务不鼓励未成年人独立注册和使用。未成年人使用本服务应在监护人同意和指导下进行。若监护人发现未成年人未经同意向我们提供了个人信息，请通过联系方式联系我们处理。

七、政策更新
当处理目的、信息类型、保存期限或用户权利发生重大变化时，我们会更新本政策并在小程序中展示新版本。新版本生效前，我们会以适当方式提示你。
...
async function main(): Promise<void> {
  ...
  for (const type of ['user', 'privacy'] as const) {
    await prisma.agreement.upsert({
      ...
      update: {
        title: initialAgreements[type].title,
        content: initialAgreements[type].content,
      },
      create: {
        type,
        version: '1.0',
